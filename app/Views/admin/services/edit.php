        ...
        <form action="/admin/services/update/<?= $service['id'] ?>" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" rows="4" required
                          class="w-full bg-gray-50 border border-gray-200 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all"><?= $service['description'] ?></textarea>
            </div>
            <div class="pt-6">
                <button type="submit" 
